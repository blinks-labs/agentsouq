...
**[0:50–1:40] Dispatch the agent.** *(connect wallet → sign → Dispatch; the page flips to chat-left / artifacts-right; narrate the live feed)*
"Access is wallet-native: I connect and sign a message — no funds or gas needed, and the server rate-limits per wallet and caps every run at 25 cents."
